...
#Spliting the data
data_inputs = dataset.iloc[:, 0:8].values
data_outputs = dataset.iloc[:, 8].values
...
#data_inputs = dataset.drop("Outcome",axis=1)
#data_outputs = dataset["Outcome"]
...
#pickle.dump(elast_layer,open('Diabetes.pkl','wb'))
